...
class FilterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        with(binding) {
            ...
            switchMediterranean.isChecked = viewModel.getStateSwitch(KEY_STATE_SWITCH_MEDITERRANEAN)
        }
        ...
        with(binding) {
            ...
            switchMediterranean.setOnClickListener {
                viewModel.saveStateSwitch(
                    KEY_STATE_SWITCH_MEDITERRANEAN,
    ...
    companion object {
        ...
        const val KEY_STATE_SWITCH_MEDITERRANEAN = "mediterranean"
    }
}
